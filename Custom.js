...
class Handlers
{
    ...
    */
    ...
    public static RulesOption("请求中文内容")
    
    var m_Chinese: boolean = false;
    public static RulesOption("紫光")
    var m_zg: boolean = false;
    ...
    public static RulesOption("Simulate &Modem Speeds", "Performance")
    var m_SimulateModem: boolean = false;

    // Removes HTTP-caching related headers and specifies "no-cache" on requests and responses
    public static RulesOption("&Disable Caching", "Performance")
    var m_DisableCaching: boolean = false;
        
    public static RulesOption("启动修改请求", "自定应开关")
    var m_ModifyRequest: boolean = false;
    public static RulesOption("启动修改响应", "自定应开关")
    var m_ModifyResponse: boolean = false;
        
            
                
    

    public static RulesOption("Cache Always &Fresh", "Performance")
    ...
    static function OnBeforeRequest(oSession: Session) {
        ...
        if(m_ModifyRequest  && oSession.host.IndexOf("www.baidu.com") > -1){
            ...
            FiddlerApplication.Log.LogString("正在修改请求");
            //服务器拒绝连接
            oSession.host="1.0.0.1";
            //服务器连接超时
    ...
    */
    ...
    static function OnBeforeResponse(oSession: Session) {
        ...
        if(m_ModifyResponse && (oSession.host.IndexOf("www.baidu.com")  > -1)  && (oSession.url.IndexOf("hello") > -1)){  
            FiddlerApplication.Log.LogString("正在修改返回消息体");
            // 重新设置Response Body  
            oSession.ResponseHeaders['Server']="test Server";
            
        
            oSession.utilSetResponseBody("<h1>test response</h1>");  
        ...
        if((res.IndexOf("somebody") > -1)|(res.IndexOf("神奇四侠") > -1)|(res.IndexOf("kylin") > -1)){
            
            oSession["ui-color"] = "orange";
        }
        
        if((oSession.fullUrl.IndexOf("web.php/Golddrilltransaction/transactionList/token/2f567d6ef7d7aece1ca4325621c5e3b1/status/0/type/1/page/1/order/id/sort/desc/filterData/%7B%22min_unit_price%22:%221%22,%22max_unit_price%22:%224.5%22%7D")>-1)){
            ...
            if((res.IndexOf("user")>-1)){
                ...
                System.Diagnostics.Process.Start("D:\8855.wav");
                }
